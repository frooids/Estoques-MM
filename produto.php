...
<body>
    <div class="container">
        <form action="produto.php" method="POST">
            <h2>Escolha de itens do produto</h2>
                <br><br>
            ...
            <div class="form-group">
                    ...
                    <input type="number" required class="form-control" id="valor_produto" step=".01" name="valor_produto" placeholder="Digite o valor">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                    ...
                    <textarea id="info_produto" class="form-control" name="info_produto" rows="4" cols="50"></textarea>
            </div>
        ...
        <table id ="tab_produto" class="table-striped">
                <tr>
                    <th>Cód.</th>
                    <th>Foto</th>
                    <th>Nome</th>
